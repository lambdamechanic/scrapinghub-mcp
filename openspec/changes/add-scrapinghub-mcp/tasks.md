...
- [ ] 1.4 Implement mutating vs non-mutating API gating with explicit `--allow-mutate` flag, load mutating mappings from `scrapinghub-mcp.mutations.yaml`, and add tests for gating behavior and classification mapping.
